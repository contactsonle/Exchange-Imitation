...
/** This class represents a sweeping order that is sent to an exchange
/*  via its sweep method. The exchange will locate the appropriate
/* market and the market will locate the appropriate order book and
/* the order book will traverse its price levels sweeping the resting
/* orders in the book with this sweeping order until the order is
/* completely filled or the order is no longer marketable or the
/* order book is completely exhausted.
*/
